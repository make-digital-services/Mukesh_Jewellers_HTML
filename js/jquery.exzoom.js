    ...
    let methods = {
        ...
        setImg: function () {
            ...
            getImageSize(url, function (width, height) {
                ...
                exzoom_img_ul.append('<li style="width: ' + boxWidth - 30 + 'px;">' +
                    '<img src="' + url + '"></li>');
...
<p class='exzoom_preview'>
    ...
    function previewImg(image_prop) {
        ...
        exzoom_zoom_outer.css({
            "width": image_prop[3] - 30 + "px",
            "height": image_prop[4] - 100 + "px",
            "top": image_prop[5] + "px",
            "left": image_prop[6] + "px",
            "position": "relative"
        });
        exzoom_zoom.css({
            "width": image_prop[7] - 25 + "px",
            "height": image_prop[7] - 25 + "px"
        });
        exzoom_preview_img.css({
